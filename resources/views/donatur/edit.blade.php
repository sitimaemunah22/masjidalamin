    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="m-3" method="POST" action="{{ route('donatur.update' , ['id' => $donatur->id_donatur]) }}" enctype="multipart/form-data">
                    @csrf
                     <div class="mt-3 form-group">
                      <label for="id" class="form-label">Id Donatur</label>
                      <input type="integer" class="form-control" id="id_donatur" name="id_donatur" value="{{ $donatur->id_donatur }}" required>
                    </div>
