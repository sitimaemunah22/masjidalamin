...
class DonaturController extends Controller
{
     ...
     */
    public function show(Donatur $donatur, Request $request)
    {
    ...
    public function update(Request $request, Donatur $donatur)
    {
        ...
        if ($validator->fails()) {
            ...
            $donatur_update->id_donatur = $request->id_donatur;
     ...
     */
    public function destroy(Donatur $donatur, Request $request)
    {
        $donatur = Donatur::find($request->id);
        $date = Carbon::now();
    ...
    public function download(Request $request){
        $donatur = Donatur::find($request->id);
        $file = public_path('assets/donatur/uploads/'.$donatur->upload);
